...
import { MyFormValues } from "../../models/data";
          ...
          <form className="mt-7" onSubmit={props.handleSubmit}>
            <div className="grid grid-cols-12 text-left">
              <div className="md:col-span-6 xs:col-span-full">
                <Label className="dark:text-mediumGray" label="TITLE" />
                <Input
                  id="title"
              ...
              <div className="md:col-span-6 xs:col-span-full">
                <Label label="PRICE" className="dark:text-mediumGray" />
                <Input
                  id="price"
                  type="number"
            ...
            <div className="grid grid-cols-12 text-left">
              <div className="md:col-span-6 xs:col-span-full">
                <Label label="STATUS" className="dark:text-mediumGray" />
                <Input
                  id="status"
                  type="text"
            ...
            <div className="flex text-left space-x-2 my-5">
              <Button
                type="submit"
